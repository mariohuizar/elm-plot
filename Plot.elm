...
import Plot.Dom.Position
import Plot.Plot.Axis as Axis
import Plot.Plot.Tick as Tick
import Plot.Plot.Grid as Grid
import Plot.Plot.Area as Area
import Plot.Plot.Pile as Pile
import Plot.Plot.Scatter as Scatter
import Plot.Plot.Line as Line
import Plot.Plot.Hint as Hint
import Plot.Internal.Grid as GridInternal
import Plot.Internal.Axis as AxisInternal
import Plot.Internal.Pile as PileInternal
import Plot.Internal.Bars as BarsInternal
import Plot.Internal.Area as AreaInternal
import Plot.Internal.Scatter as ScatterInternal
import Plot.Internal.Line as LineInternal
import Plot.Internal.Tick as TickInternal
import Plot.Internal.Hint as HintInternal
import Plot.Internal.Stuff exposing (..)
import Plot.Internal.Types exposing (..)
import Plot.Internal.Draw exposing (..)
import Plot.Internal.Scale exposing (..)
...
cmdPosition meta eventPosition =
    Task.map2
        ...
        (Plot.Dom.Position.left meta.id)
        (Plot.Dom.Position.top meta.id)
